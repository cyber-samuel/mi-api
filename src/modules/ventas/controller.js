...
const cambiarEstado= async (req, res, next) => { try { success(res, await service.cambiarEstado(Number(req.params.id), estadoVentaSchema.parse(req.body).id_estado), 'Estado actualizado'); } catch (e) { next(e); } };
